...
namespace Ecwid.Legacy
{
    ...
    public partial class EcwidLegacyClient : BaseEcwidClient, IEcwidLegacyClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EcwidLegacyClient" /> class without configuration.
        /// </summary>
        ...
        private void WaitLimit()
        {
            ...
            {
                throw new EcwidLimitException("Internal error in limits services. Look inner exception.", exception);
            }
        }
