...
namespace Ecwid.Services
{
    ...
    public static class OrdersQueryBuilderExtensions
    {
        ...
        public static OrdersQueryBuilder<TOrder, TUpdateResponse> Custom<TOrder, TUpdateResponse>(this OrdersQueryBuilder<TOrder, TUpdateResponse> query, string name, object value)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> Date(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, DateTime date)
        ...
        /// <param name="query">The query.</param>
        /// <param name="date">The date.</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> FromDate(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, DateTime date)
        ...
        /// <param name="query">The query.</param>
        /// <param name="date">The date.</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> ToDate(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, DateTime date)
        ...
        /// <param name="query">The query.</param>
        /// <param name="date">The date.</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> FromUpdateDate(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, DateTime date)
        ...
        /// <param name="query">The query.</param>
        /// <param name="date">The date.</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> ToUpdateDate(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, DateTime date)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> Order(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, int number)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> Order(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string vendorNumber)
        ...
        /// <param name="query">The query.</param>
        /// <param name="number">The ordinary order number</param>
        public static OrdersQueryBuilder<OrderEntry, UpdateStatus> Order(this OrdersQueryBuilder<OrderEntry, UpdateStatus> query, int number)
        ...
        /// <param name="query">The query.</param>
        /// <param name="vendorNumber">The vendor order number (order number with prefix/suffix)</param>
        public static OrdersQueryBuilder<OrderEntry, UpdateStatus> Order(this OrdersQueryBuilder<OrderEntry, UpdateStatus> query, string vendorNumber)
        ...
        /// <param name="query">The query.</param>
        /// <param name="number">The ordinary order number</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> FromOrder(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, int number)
        ...
        /// <param name="query">The query.</param>
        /// <param name="vendorNumber">The vendor order number (order number with prefix/suffix)</param>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> FromOrder(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string vendorNumber)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> CustomerId(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, int? customerId)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> CustomerEmail(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string customerEmail)
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> Statuses(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string paymentStatuses, string fulfillmentStatuses)
        {
        ...
        /// <param name="paymentStatuses">Payment statuses: PAID==ACCEPTED, DECLINED, CANCELLED, AWAITING_PAYMENT==QUEUED, CHARGEABLE, REFUNDED, INCOMPLETE</param>
        /// <exception cref="ArgumentException">Payment statuses string is invalid</exception>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> AddPaymentStatuses(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string paymentStatuses)
        {
        ...
        /// <param name="fulfillmentStatuses">Fulfillment statuses: AWAITING_PROCESSING==NEW, PROCESSING, SHIPPED, DELIVERED, WILL_NOT_DELIVER, RETURNED</param>
        /// <exception cref="ArgumentException">Fulfillment statuses string is invalid</exception>
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> AddFulfillmentStatuses(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string fulfillmentStatuses)
        {
        ...
        public static OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> Limit(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, int limit)
        ...
        /// </summary>
        /// <param name="query">The query.</param>
        /// <param name="limit">Number of orders returned in response. The default and maximal value is 100, any greater value is reset to 100.</param>
        public static OrdersQueryBuilder<OrderEntry, UpdateStatus> Limit(this OrdersQueryBuilder<OrderEntry, UpdateStatus> query, int limit)
            => query.AddOrUpdate("limit", limit);
        ...
        public static OrdersQueryBuilder<TOrder, TUpdateResponse> Offset<TOrder, TUpdateResponse>(this OrdersQueryBuilder<TOrder, TUpdateResponse> query, int offset)
            where TOrder : BaseOrder
            where TUpdateResponse : class
        ...
        public static OrdersQueryBuilder<OrderEntry, UpdateStatus> Keywords(this OrdersQueryBuilder<OrderEntry, UpdateStatus> query, string keywords)
        ...
        /// <typeparam name="TUpdateResponse">The type of the update response.</typeparam>
        /// <param name="query">The query.</param>
        public static async Task<List<TOrder>> GetAsync<TOrder, TUpdateResponse>(this OrdersQueryBuilder<TOrder, TUpdateResponse> query)
            where TOrder : BaseOrder
            where TUpdateResponse : class
        ...
        /// </summary>
        /// <param name="query">The query.</param>
        public static async Task<List<LegacyOrder>> GetPageAsync(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query)
        ...
        /// <param name="query">The query.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        public static async Task<List<LegacyOrder>> GetPageAsync(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, CancellationToken cancellationToken)
        ...
        public static async Task<LegacyUpdatedOrders> UpdateAsync(this OrdersQueryBuilder<LegacyOrder, LegacyUpdatedOrders> query, string newPaymentStatus,
        ...
        private static void ValidateAddNewParams<TOrder, TUpdateResponse>(OrdersQueryBuilder<TOrder, TUpdateResponse> query, string newPaymentStatus, string newFulfillmentStatus,
